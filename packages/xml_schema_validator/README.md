...
| Package | Função |
|---------|--------|
| [`xml_schema_builder`](https://pub.dev/packages/xml_schema_builder) | Usa este pacote para gerar classes Dart tipadas a partir de XSD |
| [`nfe_client`](https://pub.dev/packages/nfe_client) | Usa os schemas XSD gerados para todas as operações NF-e |
...
| Package | Role |
|---------|------|
| [`xml_schema_builder`](https://pub.dev/packages/xml_schema_builder) | Uses this package to generate typed Dart classes from XSD |
| [`nfe_client`](https://pub.dev/packages/nfe_client) | Uses the generated XSD schemas for all NF-e operations |
