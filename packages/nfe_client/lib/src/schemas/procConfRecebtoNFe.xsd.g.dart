...
part of 'procConfRecebtoNFe.dart';
...
@JsonSerializable()
class _ProcConfRecebtoNFeSchema {
  String? xmlns;
  @JsonKey(
  ...
  _ProcConfRecebtoNFeSchema.unsafe(
      {this.xmlns,
      required this.evento,
      required this.retEvento,
      required this.versao});
  ...
  factory _ProcConfRecebtoNFeSchema.fromXml(String xmlString,
    ...
    ;
    return _ProcConfRecebtoNFeSchema.unsafe(
  ...
  factory _ProcConfRecebtoNFeSchema.fromJson(Map<String, dynamic> json) =>
      _$ProcConfRecebtoNFeSchemaFromJson(json);
  Map<String, dynamic> toJson() => _$ProcConfRecebtoNFeSchemaToJson(this);
}
...
class infEventoComplexType_TEvento {
  ...
  infEventoComplexType_TEvento(
    ...
    ;
    if ((RegExp(r'[0-9]{1,2}').hasMatch(nSeqEvento.toString())) == false) {
    ...
    ;
    if ((RegExp(r'1\.00').hasMatch(verEvento.toString())) == false) {
      throw Exception('Invalid value for verEvento - $verEvento');
    }
    ;
...
class infEventoComplexType_TretEvento {
  ...
  infEventoComplexType_TretEvento(
    ...
    ;
    if ((nSeqEvento == null ||
            RegExp(r'[0-9]{1,2}').hasMatch(nSeqEvento.toString())) ==
        false) {
      throw Exception('Invalid value for nSeqEvento - $nSeqEvento');
    }
    ;
    ...
    ;
    if ((RegExp(r'(((20(([02468][048])|([13579][26]))-02-29))|(20[0-9][0-9])-((((0[1-9])|(1[0-2]))-((0[1-9])|(1\d)|(2[0-8])))|((((0[13578])|(1[02]))-31)|(((0[1,3-9])|(1[0-2]))-(29|30)))))T(20|21|22|23|[0-1]\d):[0-5]\d:[0-5]\d-0[1-3]:00')
...
class detEventoComplexType_infEvento {
  ...
  detEventoComplexType_infEvento(
    ...
    ;
    if ((xJust == null || xJust.toString().length <= 255) == false) {
  ...
  detEventoComplexType_infEvento.unsafe(
      {this.xmlns, required this.descEvento, this.xJust, required this.versao});
  String toXml(
...
enum descEventoEnum {
  v_ConfirmacaodaOpera("Confirmacao da Operacao"),
  v_CienciadaOperacao("Ciencia da Operacao"),
  v_DesconhecimentodaO("Desconhecimento da Operacao"),
  v_OperacaonaoRealiza("Operacao nao Realizada");
