...
import 'nfe4.dart';
part 'retConsSitNFe.xsd.g.dart';
part 'retConsSitNFe.g.dart';

@FromSchema('schemas/PL_009i_NT2021_004_v100d/retConsSitNFe_v4.00.xsd',
  imports: [
    'TNFeComplexType',
...
typedef RetConsSitNFeSchema = _RetConsSitNFeSchema;
