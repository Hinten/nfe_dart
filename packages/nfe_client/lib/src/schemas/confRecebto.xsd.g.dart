...
class _ConfRecebtoSchema {
  ...
  factory _ConfRecebtoSchema.fromXml(String xmlString,
      {String name = 'envEvento'}) {
    ...
    ;
    return _ConfRecebtoSchema.unsafe(
  ...
  factory _ConfRecebtoSchema.fromJson(Map<String, dynamic> json) =>
      _$ConfRecebtoSchemaFromJson(json);
  Map<String, dynamic> toJson() => _$ConfRecebtoSchemaToJson(this);
}
