...
class _ProcCCeNFeSchema {
  ...
  factory _ProcCCeNFeSchema.fromXml(String xmlString,
    ...
    ;
    return _ProcCCeNFeSchema.unsafe(
  ...
  factory _ProcCCeNFeSchema.fromJson(Map<String, dynamic> json) =>
      _$ProcCCeNFeSchemaFromJson(json);
  Map<String, dynamic> toJson() => _$ProcCCeNFeSchemaToJson(this);
}
