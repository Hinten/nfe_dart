...
_ProcCCeNFeSchema _$ProcCCeNFeSchemaFromJson(Map<String, dynamic> json) =>
    _ProcCCeNFeSchema(
...
Map<String, dynamic> _$ProcCCeNFeSchemaToJson(_ProcCCeNFeSchema instance) =>
    <String, dynamic>{
...
detEventoComplexType_infEvento _$detEventoComplexType_infEventoFromJson(
    ...
    detEventoComplexType_infEvento(
      ...
      xCorrecao: json['xCorrecao'] as String,
      xCondUso: _xCondUsoEnumFromValue(json['xCondUso'] as String),
...
Map<String, dynamic> _$detEventoComplexType_infEventoToJson(
    ...
    <String, dynamic>{
      ...
      'xCorrecao': instance.xCorrecao,
      'xCondUso': _xCondUsoEnumToValue(instance.xCondUso),
