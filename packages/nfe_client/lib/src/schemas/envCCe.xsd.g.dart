...
class _EnvCCeSchema {
  ...
  String idLote;
  @JsonKey(
      fromJson: _TEventoComplexTypeListFromJson,
      toJson: _TEventoComplexTypeListToJson)
  List<TEventoComplexType> evento;
  String versao;
  ...
  _EnvCCeSchema.unsafe(
      {this.xmlns,
      required this.idLote,
      required this.evento,
      required this.versao});
  String toXml(
      {String name = 'envEvento', bool pretty = false, String? xmlns}) {
    final element = xml.XmlElement(xml.XmlName(name), [
      ...
      ...evento
          .map((e) => xml.XmlDocumentFragment.parse(
              e.toXml(name: "evento", pretty: pretty)))
          .toList()
    ]);
    return pretty ? element.toXmlString(pretty: true) : element.toXmlString();
  }

  factory _EnvCCeSchema.fromXml(String xmlString, {String name = 'envEvento'}) {
    ...
    ;
    return _EnvCCeSchema.unsafe(
      xmlns: element.getAttribute('xmlns'),
      versao: element.getAttribute('versao')!,
      idLote: element.findElements('idLote').first.text,
      evento: element
          .findElements('evento')
          .map((e) => TEventoComplexType.fromXml(e.toString(), name: "evento"))
          .toList(),
    );
  }
  factory _EnvCCeSchema.fromJson(Map<String, dynamic> json) =>
      _$EnvCCeSchemaFromJson(json);
  Map<String, dynamic> toJson() => _$EnvCCeSchemaToJson(this);
}
...
class detEventoComplexType_infEvento {
  ...
  String xCorrecao;
  @JsonKey(fromJson: _xCondUsoEnumFromValue, toJson: _xCondUsoEnumToValue)
  xCondUsoEnum xCondUso;
  ...
  detEventoComplexType_infEvento(
      ...
      required this.xCorrecao,
      required this.xCondUso,
      required this.versao}) {
    if ((descEvento.toString().trim() == descEvento.toString()) == false) {
      throw Exception('Invalid value for descEvento');
    }
    ;
    if ((xCorrecao.toString().length <= 1000) == false) {
      throw Exception('Invalid value for xCorrecao');
    }
    ;
    if ((xCorrecao.toString().length >= 15) == false) {
      throw Exception('Invalid value for xCorrecao');
    }
    ;
    if ((RegExp(r'[!-ÿ]{1}[ -ÿ]{0,}[!-ÿ]{1}|[!-ÿ]{1}')
            .hasMatch(xCorrecao.toString())) ==
        false) {
      throw Exception('Invalid value for xCorrecao - $xCorrecao');
    }
    ;
    if ((xCorrecao.toString().trim() == xCorrecao.toString()) == false) {
      throw Exception('Invalid value for xCorrecao');
    }
    ;
    if ((xCondUso.toString().trim() == xCondUso.toString()) == false) {
      throw Exception('Invalid value for xCondUso');
    }
    ;
    if ((versao.toString().trim() == versao.toString()) == false) {
      throw Exception('Invalid value for versao');
  ...
  String toXml(
    ...
    final element = xml.XmlElement(xml.XmlName(name), [
      ...
      xml.XmlElement(
          xml.XmlName('xCorrecao'), [], [xml.XmlText(xCorrecao.toString())]),
      xml.XmlElement(xml.XmlName('xCondUso'), [], [xml.XmlText(xCondUso.value)])
    ]);
    return pretty ? element.toXmlString(pretty: true) : element.toXmlString();
  }
  ...
  factory detEventoComplexType_infEvento.fromXml(String xmlString,
    ...
    return detEventoComplexType_infEvento.unsafe(
      ...
      xCorrecao: element.findElements('xCorrecao').first.text,
      xCondUso:
          xCondUsoEnum.fromValue(element.findElements('xCondUso').first.text),
    );
  }
...
enum descEventoEnum {
  v_CartadeCorreo("Carta de Correção"),
  v_CartadeCorrecao("Carta de Correcao");
...
enum xCondUsoEnum {
  ...
  v_ACartadeCorrecaoed(
      "A Carta de Correcao e disciplinada pelo paragrafo 1o-A do art. 7o do Convenio S/N, de 15 de dezembro de 1970 e pode ser utilizada para regularizacao de erro ocorrido na emissao de documento fiscal, desde que o erro nao esteja relacionado com: I - as variaveis que determinam o valor do imposto tais como: base de calculo, aliquota, diferenca de preco, quantidade, valor da operacao ou da prestacao; II - a correcao de dados cadastrais que implique mudanca do remetente ou do destinatario; III - a data de emissao ou de saida.");

  final String value;
  const xCondUsoEnum(this.value);
  factory xCondUsoEnum.fromValue(String value) {
    for (final item in xCondUsoEnum.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError("Invalid value for xCondUsoEnum: $value");
  }
}

xCondUsoEnum? _xCondUsoEnumFromMaybeValue(String? value) =>
    value != null ? xCondUsoEnum.fromValue(value) : null;
String? _xCondUsoEnumToMaybeValue(xCondUsoEnum? value) =>
    value != null ? value.value : null;

xCondUsoEnum _xCondUsoEnumFromValue(String value) =>
    xCondUsoEnum.fromValue(value);
String _xCondUsoEnumToValue(xCondUsoEnum value) => value.value;

List<xCondUsoEnum>? _xCondUsoEnumFromMaybeList(List<String>? value) =>
    value?.map((e) => xCondUsoEnum.fromValue(e)).toList();
List<String>? _xCondUsoEnumToMaybeList(List<xCondUsoEnum>? value) =>
    value?.map((e) => e.value).toList();

List<xCondUsoEnum> _xCondUsoEnumFromList(List<String> value) =>
    value.map((e) => xCondUsoEnum.fromValue(e)).toList();
List<String> _xCondUsoEnumToList(List<xCondUsoEnum> value) =>
    value.map((e) => e.value).toList();
