...
@JsonSerializable()
class _RetEnvEventoCancNFeSchema {
  String? xmlns;
  String idLote;
  ...
  _RetEnvEventoCancNFeSchema.unsafe(
      {this.xmlns,
      required this.idLote,
      required this.tpAmb,
      required this.verAplic,
  ...
  factory _RetEnvEventoCancNFeSchema.fromXml(String xmlString,
    ...
    ;
    return _RetEnvEventoCancNFeSchema.unsafe(
  ...
  factory _RetEnvEventoCancNFeSchema.fromJson(Map<String, dynamic> json) =>
      _$RetEnvEventoCancNFeSchemaFromJson(json);
  Map<String, dynamic> toJson() => _$RetEnvEventoCancNFeSchemaToJson(this);
}
