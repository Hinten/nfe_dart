...
part of 'retEnvConfRecebto.dart';
...
@JsonSerializable()
class _RetEnvConfRecebtoSchema {
  String? xmlns;
  String idLote;
  ...
  _RetEnvConfRecebtoSchema.unsafe(
      {this.xmlns,
      required this.idLote,
      required this.tpAmb,
      required this.verAplic,
  ...
  factory _RetEnvConfRecebtoSchema.fromXml(String xmlString,
    ...
    ;
    return _RetEnvConfRecebtoSchema.unsafe(
  ...
  factory _RetEnvConfRecebtoSchema.fromJson(Map<String, dynamic> json) =>
      _$RetEnvConfRecebtoSchemaFromJson(json);
  Map<String, dynamic> toJson() => _$RetEnvConfRecebtoSchemaToJson(this);
}
