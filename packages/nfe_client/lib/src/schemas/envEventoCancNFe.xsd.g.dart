...
class _EnvEventoCancNFeSchema {
  ...
  _EnvEventoCancNFeSchema.unsafe(
      {this.xmlns,
      required this.idLote,
      required this.evento,
      required this.versao});
  ...
  factory _EnvEventoCancNFeSchema.fromXml(String xmlString,
    ...
    ;
    return _EnvEventoCancNFeSchema.unsafe(
  ...
  factory _EnvEventoCancNFeSchema.fromJson(Map<String, dynamic> json) =>
      _$EnvEventoCancNFeSchemaFromJson(json);
  Map<String, dynamic> toJson() => _$EnvEventoCancNFeSchemaToJson(this);
}
