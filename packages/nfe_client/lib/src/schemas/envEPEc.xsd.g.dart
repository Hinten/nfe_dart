...
class _EnvEPECSchema {
  ...
  factory _EnvEPECSchema.fromXml(String xmlString,
  ...
  factory _EnvEPECSchema.fromJson(Map<String, dynamic> json) =>
      _$EnvEPECSchemaFromJson(json);
  Map<String, dynamic> toJson() => _$EnvEPECSchemaToJson(this);
}
...
enum cOrgaoAutorEnum {
  ...
  final String value;
  const cOrgaoAutorEnum(this.value);
  factory cOrgaoAutorEnum.fromValue(String value) {
    for (final item in cOrgaoAutorEnum.values) {
      if (item.value == value) {
        return item;
      }
    }
    throw ArgumentError("Invalid value for cOrgaoAutorEnum: $value");
  }
}
